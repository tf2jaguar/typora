...
![](pic/TCP协议灵魂之问/v2-dbbdb2ba824a121f18a66059ac0b5ac2_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-859c73d767b7211e7f094ecaa4938fde_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-c99d5f1fe9d483073ff358adab8e4e24_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-3943c6b3b43a16659578334e18c30003_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-5420c5865277deb412a7908957be7076_1440w.jpg)
...
序列号在 TCP 通信的过程中有两个作用: 1. 在 SYN 报文中交换彼此的初始序列号。 2. 保证数据包按正确的顺序组装。
...
![](pic/TCP协议灵魂之问/v2-8400842fde097a15139515f3887c0e0c_1440w.jpg)
...
接下来我们就来一一梳理，TCP 的时间戳主要解决两大问题: - 计算往返时延 RTT(Round-Trip Time) - 防止序列号的回绕问题

### 计算往返时延 RTT

在没有时间戳的时候，计算 RTT 会遇到的问题如下图所示:

![](pic/TCP协议灵魂之问/v2-56464c07cd5592cfa97bbc661cdb9233_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-3cd9e36dfbad543a00dba1a430708af5_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-694b4932025a64c2ba9ca0a02c8810ce_1440w.jpg)
...
![](pic/TCP协议灵魂之问/v2-eb29637c332d0920aacf383107930215_1440w.jpg)
...
不过需要主要的是，有一些场景是不能延迟确认的，收到了就要马上回复: \- 接收到了大于一个 frame 的报文，且需要调整窗口大小 - TCP 处于 quickack 模式（通过tcp\_in\_quickack_mode设置） - 发现了乱序包
...
文章首发于[我的博客](https://link.zhihu.com/?target=https%3A//github.com/sanyuan0704/my_blog)，如果觉得对你有帮助的话，希望能帮忙点一个 star，非常感谢~

下期预告: HTTP 协议

![](pic/TCP协议灵魂之问/v2-75c7d8a762c96f02e683e9dc11349ecd_1440w.jpg)
